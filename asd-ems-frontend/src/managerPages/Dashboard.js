  ...
  if (localStorage.getItem('id') !== null) {
    return (
      <div>
        ...
        <li>
          As an employee from the Human Resource (HR) department, also known as the admin
          in the EMS system, you have the priviledge to view, add, delete and modify
          employees as well as your personal information.
        </li>
        <li>
