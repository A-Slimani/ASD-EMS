...
class payrollHistory extends React.Component {
  state = {
    collapsed: false,
  };
        ...
        <Layout className="site-layout">
          ...
          <Content style={{ margin: '0 16px' }}>
            <Breadcrumb style={{ margin: '16px 0' }}>
              ...
              <Breadcrumb.Item> Payroll History </Breadcrumb.Item>
            </Breadcrumb>

            <div style={{textAlign: 'center'}}>
              <h1 style={{textAlign: 'center'}}> Payroll History </h1>
              ...
              <input type="date" placeholder="Pay Date" name="Paydate" class="textfield"/>
