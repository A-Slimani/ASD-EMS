          ...
          <Content style={{ margin: '0 16px' }}>
            ...
            <div>  
              ...
              <p><br></br><i>Many thanks,</i><br></br> 
                Martin Lym <br/> <br/>
                Human Resources Manager <br/> <b> Enterprise Management Systems</b></p></p>

              <div style={{textAlign: 'center', paddingTop: 10}}> <Link to="#"> <button className="button"> Update Policy </button> </Link> </div>
            </div>
